...
def main():
    ...
    for e in range(args.epoch):
        ...
        (val_acc, val_precision, val_recall, val_fscore, _, err, mat) = net_test(fusion_net_cuda, val_dataloader, scene_to_event)
        print(
        ...
        if val_fscore > max_fscore:
            ...
            print('mark...')
            print('err %.4f' % err)
            np.save('scene_to_event/KL_%d_epoch.npy' % e, mat)
            #print(results)
